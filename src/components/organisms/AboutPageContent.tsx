          ...
          >
            ...
            <motion.div variants={fadeUp} className="space-y-7">
              ...
              <p className="text-lg text-gray-600 max-w-xl leading-relaxed">
                IIK has been the heart of the Indian diaspora in Korea since
                March 25, 2002 — a platform for sharing happiness, sadness, and
          ...
          >
            <motion.div variants={fadeUp} className="space-y-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed text-base">
                <p>
                  IIK is one of the largest and oldest Indian community groups
                  in Korea. Since its establishment on{" "}
                  <strong className="text-gray-800">March 25, 2002</strong>, it
                  has been a platform for sharing happiness and sadness, and a
                  go-to source of information for all Indians living in or
                  coming to Korea.
                </p>
                <p>
                  Over{" "}
                  <strong className="text-gray-800">10,000+ members</strong> are
                  closely associated across the Republic of Korea via the IIK
                ...
                <p>
                  ...
                  with over 12,000 members, including Indians living in Korea
                  and Koreans who are interested in India and its culture.
                </p>
              </div>
